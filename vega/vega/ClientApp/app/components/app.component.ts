...
export class AppComponent implements OnInit, AfterViewInit {
    ...
    get canViewMakes() {
        return this.accountService.userHasPermission(Permission.viewUsersPermission); //eg. viewMakesPermission
    }

    get canViewModels() {
        return this.accountService.userHasPermission(Permission.viewUsersPermission); //eg. viewModelsPermission
    }
