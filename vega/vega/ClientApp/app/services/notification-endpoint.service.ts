...
export class NotificationEndpoint {
    ...
    private demoNotifications = [
        {
            "id": 1,
            "header": "10 New Models were added to your inventory by \"administrator\"",
            "body": "5 new \"BMW M6\" were added to your stock by \"administrator\" on 5/28/2017 4:54:13 PM",
            "isRead": true,
            "isPinned": true,
        ...
        },
        {
            ...
            "body": "You are running low on \"Toyota Prius\". 2 Items remaining",
            "isRead": false,
            "isPinned": false,
